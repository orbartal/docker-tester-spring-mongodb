...
import orbartal.demo.spring.mongodb.business.DemoBusiness;
...
public class DemoApp {
	...
	@Autowired
	private DemoInfoDtoMapper mapper;
	...
	public ResponseEntity readAll() {
		try {
			List<DemoInfo> out = business.readAll();
			List<DemoDto> dtos = out.stream().map(i -> mapper.toDto(i)).toList();
